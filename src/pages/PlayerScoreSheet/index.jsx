...
const PlayerScoreSheet = ({onClick, players, currentPlayer, setPlayers}) => {
    ...
    return ( <div className="flex flex-col justify-between w-full h-screen">
        ...
        <input className="my-6 text-5xl text-center text-gray-800 " placeholder="0" type="numeric" min="1" max='99' pattern="[0-9]*" maxLength={2} value={destinationCardWorth} onChange={(e)=>setDestinationCardWorth(e.target.value)}/>
